    ...
    <section id="about" className="relative border-t border-border bg-background py-20 sm:py-28">
      <div className="container grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <div className="relative">
          <div className="absolute -inset-2 bg-gradient-amber opacity-20 blur-2xl" />
          <img
            src={beersTrio}
            alt="Three craft beers from above"
            loading="lazy"
            width={1280}
            height={896}
        ...
        <div>
          ...
          <p className="mt-6 text-base leading-relaxed text-muted-foreground sm:text-lg">{t("about.body")}</p>
          <div className="mt-8 grid grid-cols-3 gap-4 border-t border-border pt-6">
            {[
              ...
              <div key={s.l}>
                <div className="font-display text-3xl text-gradient-amber">{s.n}</div>
